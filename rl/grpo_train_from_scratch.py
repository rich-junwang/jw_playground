...
# --------------------------------------
model_name = "Llama-3.2-1B-Instruct" # what I use: Llama-3.2-1B-Instruct
# Load tokenizer
...
train_data = datasets.load_dataset(data_source, "main")
...
if master_process:
    print(f"It will run {max_steps} steps per epoch.")
