"""
Reference:
* https://github.com/ray-project/ray/blob/ray-2.43.0/doc/source/serve/doc_code/vllm_openai_example.py
* https://docs.ray.io/en/releases-2.43.0/serve/tutorials/vllm-example.html
"""
...
from vllm.entrypoints.openai.serving_chat import BaseModelPath, LoRAModulePath, OpenAIServingChat, PromptAdapterPath
...
def build_app(cli_args: Dict[str, str]) -> serve.Application:
    ...
    _port = 5678 + int(os.getenv("RANK", "0"))
    print(f"Debugger at {_port}")
    debugpy.listen(("localhost", _port))
